...
lossWeights = {"output1": 1, "output2": 1}
...
for i in folds:
    ...
    model.compile(loss={'output1': tf.keras.losses.Huber(), 'output2': 'categorical_crossentropy'}, loss_weights=lossWeights, optimizer='adam', 
                  metrics = {'output1': 'MeanSquaredError', 'output2': 'accuracy'})
    earlystopping = EarlyStopping(monitor='val_loss', patience=20)
    weights_path = "Checkpoints1/SSNetV2-{0}.hdf5".format(i)
